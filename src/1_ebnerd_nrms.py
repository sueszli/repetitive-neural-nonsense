...
df_validation = add_prediction_scores(df_validation, pred_validation.tolist()).pipe(add_known_user_column, known_users=df_train[DEFAULT_USER_COL])
...
print("\n\nevaluation:", metrics.evaluate(), sep="\n")
...
print("\n\npred_test:", pred_test, sep="\n")

submission_path = Path(os.getcwd()) / "submissions" / "ebnerd_nrms.txt"

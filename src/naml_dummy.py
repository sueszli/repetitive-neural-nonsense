...
his_input_title = np.random.randint(0, vocab_size, size=(BATCH_SIZE, HISTORY_SIZE, TITLE_SIZE))
his_input_body = np.random.randint(0, vocab_size, size=(BATCH_SIZE, HISTORY_SIZE, BODY_SIZE))
...
pred_input_title = np.random.randint(0, vocab_size, size=(BATCH_SIZE, NPRATIO + 1, TITLE_SIZE))
pred_input_body = np.random.randint(0, vocab_size, size=(BATCH_SIZE, NPRATIO + 1, BODY_SIZE))
